...
from app.scraper import FAILURE_TIMEOUT, ScrapeResult, scrape_price
...
class TestScrapeTimeout:
    ...
    async def test_wedged_browser_does_not_hold_the_slot(self, monkeypatch):
        ...
        assert result == ScrapeResult(None, None, None, FAILURE_TIMEOUT)
        ...
        assert again == ScrapeResult(None, None, None, FAILURE_TIMEOUT)
