  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          {!isPostgres && (
            <span className="absolute top-2 right-2 text-xs bg-indigo-100 text-indigo-700 px-2 py-0.5 rounded-full font-medium">
              default
            </span>
          )}
          <p className="font-semibold text-gray-900">SQLite</p>
          <p className="text-xs text-gray-500 mt-1">Simple file-based database, perfect for homelab</p>
        </button>
        ...
        >
          ...
          <p className="text-xs text-gray-500 mt-1">Full-featured database for multi-user setups</p>
        </button>
      </div>
