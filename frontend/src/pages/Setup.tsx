...
import {
  ...
  Shield, Database, Bell, Users, Check, Info, Code, Plus, Pencil, X
} from 'lucide-react'
...
function SelectorDefaultsSection({ showToast }: { showToast: (msg: string) => void }) {
    ...
    <div className="max-w-3xl mx-auto px-4 py-6 space-y-5">
      ...
      {activeTab === 'admin' && me?.is_admin && (
        <div className="space-y-4">
          ...
          <SelectorDefaultsSection showToast={showToast} />
