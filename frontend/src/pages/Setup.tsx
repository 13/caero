...
import {
  ...
  Shield, Database, Bell, Users, Check, Info, Code, Plus, Pencil, X, Eye, EyeOff
} from 'lucide-react'
...
function SelectorDefaultsSection({ showToast, isAdmin }: { showToast: (msg: string) => void; isAdmin: boolean }) {
        ...
        <div className="space-y-4">
          ...
          <Section icon={Bell} title="Notification tests" description="Verify email and Telegram alerts are working">
            <div className="space-y-2 pb-2 border-b border-gray-100 dark:border-gray-800">
              ...
              <p className="text-xs text-gray-400 dark:text-gray-500">
                Obtain from <span className="font-mono">@BotFather</span> on Telegram. Overrides the <span className="font-mono">TELEGRAM_BOT_TOKEN</span> env var.
              </p>
            </div>
